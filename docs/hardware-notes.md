...
The Bobcat RK3566 Nebra/OpenFleet reference image and the tested board both
use the same early MBR layout:

| Partition | Type | Start LBA | Sectors | Notes |
| --- | --- | ---: | ---: | --- |
| 1 | `0x0e` | 81920 | 81920 | FAT boot marker partition |
| 2 | `0x83` | 163840 | 1179648 | Balena root A in reference image |
| 3 | `0x83` | 1343488 | 1179648 | Balena root B in reference image |
...
It also looks for a `balena-image` marker on partition 1. The builder creates a
